...
export { default as AboutText } from './molecules/About/aboutText'
export { default as AboutPic } from './molecules/About/aboutPic'
...
export { default as ProjectImage } from './atoms/projectImage'
